...
6. Creator names and cover URLs are parsed, but the adapter does not import the source's release description or creator credits into canonical metadata. Extending canonical reconciliation should include provenance and field-level human overrides.
